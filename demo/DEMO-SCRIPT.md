...
| 1:45–2:05 | Terminal | Switch to terminal, run `npm run demo`. "The same server through the CLI client: initialize, list tools, submit, live events, collect. And `npm test` — nineteen tests including this full lifecycle end-to-end." |
